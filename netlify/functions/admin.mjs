...
export default async req=>{
  try{
    ...
    if(action==='add-driver'){
      ...
      const record={id,name,codeHash:hashSecret(code),enabled:true,photoVersion:photo instanceof File && photo.size>0?Date.now():''};
