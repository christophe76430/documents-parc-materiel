import { MACHINES,TYPES,expectedTypes,store,parseCookies,validToken,cookie,makeToken,html,esc,alertState,getMachineStatus,hasExtinguisher,getExtinguisherDates } from './_shared.mjs';
